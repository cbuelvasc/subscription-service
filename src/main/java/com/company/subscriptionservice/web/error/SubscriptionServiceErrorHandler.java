package com.company.subscriptionservice.web.error;
...
@ControllerAdvice
public class SubscriptionServiceErrorHandler {

    private static final Logger LOG = LoggerFactory.getLogger(SubscriptionServiceErrorHandler.class);
